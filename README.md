...
| :---: | :---: | :---: |
| ![Historial](capturas/13_general_historial.png) | ![Estudiantes](capturas/14_general_formulario.png) | ![Cursos](capturas/15_general_estudiantes.png) |
...
Recuperación asíncrona del catálogo de estudiantes y renderizado en la interfaz.
...
![Eliminación de Estudiante](capturas/12_inscripciones_eliminar.png)
...
![Historial de Inscripciones](capturas/11_inscripciones_editar.png)
...
![Nueva Inscripción](capturas/06_cursos_crear.png)
...
![Modificación de Inscripción](capturas/09_inscripciones_historial.png)
...
![Anulación de Inscripción](capturas/08_cursos_eliminar.png)